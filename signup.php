...
if(isset($_POST['submit']))
{
    ...
    mysqli_query($con,"INSERT INTO `login`(`email`, `password`) VALUES ('$email','$pass')");
    $id=mysqli_insert_id($con);
    mysqli_query($con,"INSERT INTO `signup`(`id`,`name`, `phone`, `dob`, `gender`) VALUES ('$id','$name','$phone','$dob','$value')");
echo "<script>alert ('sign up is done successfully');</script>";
                ...
                <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4">
                    <div class="bg-light rounded p-4 p-sm-5 my-4 mx-3">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingText"  name="name" required>
                        ...
                        <div class="form-floating mb-3">
                            <input type="tel" class="form-control" id="floatingInput" name="phone" required>
